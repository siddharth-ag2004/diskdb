...
- Empty Results: If no rows match the join/selection conditions, the empty resultant table is gracefully discarded and deleted from the catalogue to prevent memory/disk leaks.
